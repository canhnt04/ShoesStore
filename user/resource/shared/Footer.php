...
<footer class="bg-dark" id="tempaltemo_footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    <li>
                        ...
                        273 An Dương Vương, P.2, Q.5, TP.HCM
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="mailto:info@company.com">info@sgu.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                <h2 class="h2 text-light border-bottom pb-3 border-light">MSSV</h2>
                <ul class="list-unstyled text-light footer-link-list">
